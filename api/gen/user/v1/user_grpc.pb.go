...
const (
	...
	User_GetUserRoles_FullMethodName = "/user.v1.User/GetUserRoles"
)
...
type UserClient interface {
	...
	GetUserRoles(ctx context.Context, in *UserRolesRequest, opts ...grpc.CallOption) (*UserRolesResponse, error)
}
...
func (c *userClient) GetUserRoles(ctx context.Context, in *UserRolesRequest, opts ...grpc.CallOption) (*UserRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServer interface {
	...
	GetUserRoles(context.Context, *UserRolesRequest) (*UserRolesResponse, error)
...
func (UnimplementedUserServer) GetUserRoles(context.Context, *UserRolesRequest) (*UserRolesResponse, error) {
...
func _User_GetUserRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserRoles(ctx, req.(*UserRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
